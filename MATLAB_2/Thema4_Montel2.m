%% Thema 4 i) me8odo Lyapunov me meikth domh gia online ektimhsh parametrwn
...
[t, x] = ode15s(@(t, x) system_equationsV5(t, x, u, a, b, gamma1, gamma2, theta_m), t_span, x0);
...
saveas(fig1, 'prob4_i_params_est.png')
saveas(fig2, 'prob4_i_outputs.png')
saveas(fig3, 'prob4_i_error.png')